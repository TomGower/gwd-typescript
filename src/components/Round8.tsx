  ...
  return (
    <div>
      ...
      <Question
        ...
        qnumber={1}
        checked={colors[0] === 'green' ? 'checked': ''}
      />
      <TwoPartQuestion
        round={info.round}
        qnumber={2}
        ...
        checked1={colors[1] === 'green' ? 'checked': ''}
        color2={colors[2]}
        answer2={info.answers[2]}
        checked2={colors[2] === 'green' ? 'checked': ''}
      />
      ...
      <input type="checkbox" id={`round${info.round} question3`} defaultChecked={!!(colors[3] === 'green' ? 'checked': '')} />
      ...
      <input type="checkbox" id={`round${info.round} question4a`} defaultChecked={!!(colors[4] === 'green' ? 'checked': '')} />
      ...
      <input type="checkbox" id={`round${info.round} question4b`} defaultChecked={!!(colors[5] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      <span style={{ color: colors[6] }}>Answer C</span>
      {': '}
      <input className="answer" id={`round${info.round}answer q4c`} defaultValue={info.answers[6]} />
      <input type="checkbox" id={`round${info.round} question4c`} defaultChecked={!!(colors[6] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      <Question
        round={info.round}
        ...
        checked={colors[7] === 'green' ? 'checked': ''}
      />
      ...
      <input type="checkbox" id={`round${info.round} question6a`} defaultChecked={!!(colors[8] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      <span style={{ color: colors[9] }}>Answer B</span>
      {': '}
      <input className="answer" id={`round${info.round}answer q6b`} defaultValue={info.answers[9]} />
      <input type="checkbox" id={`round${info.round} question6b`} defaultChecked={!!(colors[9] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      ...
      <input type="checkbox" id={`round${info.round} question6c`} defaultChecked={!!(colors[10] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      <Question
        round={info.round}
        ...
        checked={colors[11] === 'green' ? 'checked': ''}
      />
      ...
      <input type="checkbox" id={`round${info.round} question8a`} defaultChecked={!!(colors[12] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      ...
      <input type="checkbox" id={`round${info.round} question8b`} defaultChecked={!!(colors[13] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      ...
      <input type="checkbox" id={`round${info.round} question8c`} defaultChecked={!!(colors[14] === 'green' ? 'checked': '')} />
      <label htmlFor="question4">Check if correct</label>
      <br />
      ...
      <input type="checkbox" id={`round${info.round} question8d`} defaultChecked={!!(colors[15] === 'green' ? 'checked': '')} />
